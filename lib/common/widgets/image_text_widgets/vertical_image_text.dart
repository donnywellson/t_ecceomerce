...
class TVerticalImageText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: onTap,
      child: Padding(
        padding: const EdgeInsets.only(right: TSizes.spaceBetween),
        child: Column(
          children: [
            // Circular Icon
            Container(
              ...
              child: Center(
                child:
                    Image(image: AssetImage(image), fit: BoxFit.cover, color: THelperFunctions.isDarkMode(context) ? TColors.light : TColors.dark),
              ),
            ),
